                    ...
                    <div class="col-md-6 justify-content-center">
                        <form action="passwordController" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 removeLeftPadding removeRightPadding">
                                    <i class="fa fa-lock icon"></i>
                                    <input style="padding-left: 40px" class="textFieldDes" id="confirmPassword" type="password"
                                        placeholder="Confirm Password" name="confirmPassword" value="" required>
                                </div>
                            </div>
                            <input id="infS" class="pwBtn" name="infS" type="submit" value="Update Password">
                        </form>
                    </div>
                </div>
            </div>
